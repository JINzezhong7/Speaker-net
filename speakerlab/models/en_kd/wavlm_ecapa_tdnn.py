...
update_extract=False, config_path=None, pretrained_path=None):
    model = ECAPA_TDNN(feat_dim=feat_dim, channels=512, emb_dim=emb_dim, feat_type=feat_type, sr=sr, feature_selection=feature_selection, update_extract=update_extract, config_path=config_path)
...
if __name__ == '__main__':
    ...
    model = ECAPA_TDNN_SMALL(feat_dim=1024, emb_dim=256, feat_type='wavlm_large', feature_selection="hidden_states",
                              update_extract=False,pretrained_path="/home10a/zezhong/project/Speaker-net/egs/voxceleb/sv-en_kd/speakerlab/models/en_kd/wavlm_large_finetune.pth")
